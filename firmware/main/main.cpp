...
// `blecfg`) — a phone-facing remote control for the power switch, when there
// is one (its contact surface there is pwr::psuState() /
// pwr::remoteRequest()), that also serves
