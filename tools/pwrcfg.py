...
#   input_only: no output driver (can't be PS_ON#/button-gnd) and no internal
#               pull-up either (can't be the button, which relies on one)
#   adc:        pins the sense wire can use. C3 note: GPIO5 is its ADC2,
